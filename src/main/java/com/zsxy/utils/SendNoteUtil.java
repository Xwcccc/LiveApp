...
public class SendNoteUtil {
    ...
    private String code;
    DefaultProfile profile = DefaultProfile.getProfile("default", "LTAI5tDCpzRViraLKdSmpd3z", "b5biV3TdACcACO4Bl0O9GL3ViYya2Y");
    ...
    public String sendNoteMessgae(String PhoneNumbers){
        ...
        //签名
        request.putQueryParameter("SignName", "HitszLiveApp");
        //模板代码
        request.putQueryParameter("TemplateCode", "SMS_461380262");
        //用户定义的验证码内容
